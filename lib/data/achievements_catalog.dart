...
final List<Achievement> kAchievements = [
  ...
  Achievement('vital', 'Picking Up Pace', '🏃', 'Reach the Brisk health level',
  ...
  Achievement('thriving', 'Swift', '💨', 'Reach the Swift health level',
  ...
  Achievement('radiant', 'Soaring', '🦅',
      'Reach the top health level, Soaring', Difficulty.elite,
